...
export default function FranchiseDashboard() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        const token =
          "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySWQiOiI2ODUwZTVlOTA4OGY5ZDU5ZmU2N2Y3ODkiLCJjbGllbnRJZCI6IndlYi1hcHAtdjEiLCJpYXQiOjE3NTYxNzk4MzksImV4cCI6MTc1NjE4MzQzOX0.K-WZOOnADUMFrBOfF3icSHhZQ0efkvHC8vmJRg0NAng"; // Thay token thực tế
